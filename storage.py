...
#     def __init__(self, step_nums, env):
#         """
#         之前是有一个num_env现在把那个维度改成了n_clusters了
#         """
#         self.obs = np.zeros((step_nums, env.n_clusters) + (env.obs_space[0],), dtype='float32')
#         self.actions = np.zeros((step_nums, env.n_clusters) + (len(env.act_space),), dtype='float32')
#         self.logprobs = np.zeros((step_nums, env.n_clusters) + (len(env.act_space),), dtype='float32')
#         self.rewards = np.zeros((step_nums, env.n_clusters), dtype='float32')
#         self.dones = np.zeros((step_nums, env.n_clusters), dtype='float32')
#         self.values = np.zeros((step_nums, env.n_clusters), dtype='float32')
